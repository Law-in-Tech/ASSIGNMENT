...
class Transaction:
    ...
    def verify_transaction(self):
        """
        Verifies if the transaction complies with Nigerian financial laws (e.g., Banks and Other Financial Institutions Act, 2020; The Money Laundering (Prevention and Prohibition) Act, 2022 (MLA 2022).
        """
        if self.is_legal:
